...
with open('imgs_data/joints_lable.txt','w') as f:
    img_num=100000
    for j in range(0,5):
                ...
                with open(path+'/'+txt_file,'r') as txt:
                    ...
                    if joints.shape[1]>0:
                        for i in range(0,21):
                            ...
                            if(float(joints[0,i])<0) or(float(joints[0,i]>1920)) or (float(joints[1,i]<0))or(float(joints[1,i]>1080)):
                                useful=0
                                break
