...
class Generator(object):
    ...
    def get_random_data(self, annotation_line, jitter=.3, hue=.1, sat=1.5, val=1.5):
        ...
        if iw==1920:
            box[:,0:4]=box[:,0:4]*1280/1920
        # img_demo = cv2.imread('G:\my_data\DJI_0091_001 (2020-11-23 16-38-53)/DJI_0091_001 001.jpg')
        # print(box.shape)
        # for i in range(0,box.shape[0]):
        #     print(box)
        #     cv2.rectangle(img_demo, (int(box[i, 0]), int(box[i, 2])), (int(box[i, 1]), int(box[i, 3])),(0, 0, 255))
