...
if __name__ == "__main__":
    ...
    #   权值文件请看README，百度网盘下载
    # ------------------------------------------------------#
    model_path = 'model_data/P04_01.pth'
    ...
    # annotation_path = 'I:/faster-rcnn/faster-rcnn-pytorch-master/VOCdevkit\VOC2007/train.txt'
    annotation_path = 'H:\object_detection_images\epic_labelling\labels/P01_01.txt'
    # annotation_path = 'H:/object_detection_images/Ugrasp/ugrasp.txt'
